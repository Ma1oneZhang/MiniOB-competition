...
{
public:
  IndexScanPhysicalOperator(Table *table, Index *index, bool readonly, std::vector<ValueExpr *> &left_value,
      std::vector<ValueExpr *> &right_value, bool left_inclusive = true, bool right_inclusive = true);
